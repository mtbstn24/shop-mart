...
export default function product() {
  ...
  if (btn == "create") {
    submitBtn = (
      <button type="submit" className="w-100 btn btn-secondary btn-lg">
        {" "}
        Add Product{" "}
      </button>
    );
    ...
    if (btn == "update" && update != "") {
      ...
      axios
        ...
        .then((res) => {
          ...
          setProducts(
            [formData].concat(removeElementById(products, newProduct._id))
          );
        })
        .catch((error) => {
          console.log(error);
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 mb-0">
              <a href="index.html">Products</a> <span class="mx-2 mb-0">/</span>{" "}
          ...
          <div class="row mb-5">
                        ...
                        <div className="card-body">
                          ...
                          >
                            <div className="form-group">
                              ...
                              />
                              <label htmlFor="comission" hidden>
                                Commission :{" "}
                              </label>
                              <input
                                className="form-control mb-4"
            ...
            <div class="col-md-3 order-1 mb-5 mb-md-0">
              <div class="border p-4 rounded mb-4">
                <a href="./provider" class="h6 list-group-item">
                  <FaAlignJustify
                    color="black"
                    fontSize="16px"
                    padding-left="10"
                  />
                  <span class="p-4">Dashboard</span>
                </a>
                <a href="#" class="h6 list-group-item active">
                  <FaRegPlayCircle
                    color="black"
                    fontSize="16px"
                    padding-left="10"
                ...
                <a href="./providerservice" class="h6 list-group-item ">
                  <FaRegCalendarAlt
                    color="black"
                    fontSize="16px"
                    padding-left="10"
                ...
                <a href="./providerevents" class="h6 list-group-item ">
                  <FaQuestionCircle
                    color="black"
                    fontSize="16px"
                    padding-left="10"
                  />{" "}
                  <span class="p-4">Events</span>
                </a>
              </div>
            </div>
          </div>
